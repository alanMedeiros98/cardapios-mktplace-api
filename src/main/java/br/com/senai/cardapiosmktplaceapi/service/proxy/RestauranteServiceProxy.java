...
public class RestauranteServiceProxy implements RestauranteService {
	...
	@Override
	public Restaurante salvar(Restaurante resturante) {
		Restaurante restauranteSalvo = service.salvar(resturante);
	...
	private Notificacao gerarNotificacaoPara(Restaurante restaurante) {
		...
		texto.append("<p>O restaurante <b>").append(restaurante.getNome() + "</b> foi criado ou atualizado no sistema</p>");
		texto.append("<p>Esse email é automatico. Não deve ser respondido.</p>");
