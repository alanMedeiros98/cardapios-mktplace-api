...
public class Usuario {
	...
	@Id
	@Size(max = 50, message = "O login do usuario nao deve conter mais de 50 caracteres")
	...
	@Size(max = 120, message = "O nome do usuario nao deve conter mais de 120 caracteres")
	@NotBlank(message = "O nome do usuario é obrigatório")
	@Column(name = "nome")
	private String nome;
	
	@Enumerated(value = EnumType.STRING)
	@NotNull(message = "O pape do usuario ´r obrigatório")
	@Column(name = "papel")
	private Papel papel;
