...
public class NovaOpcaoDoCardapio {
	...
	//"O preco deve possuir o formato 'NNNNNNNNN.NN'"
	@DecimalMin(value = "0.0", inclusive = false, message = "O preco não pode ser inferior a R$0.01'")
	@Digits(integer = 9, fraction = 2, message = "O preco deve possuir o formato 'NNNNNNNNN.NN'")
